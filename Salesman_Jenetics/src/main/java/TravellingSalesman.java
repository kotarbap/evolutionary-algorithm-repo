...
public class TravellingSalesman
    ...
    public TravellingSalesman(ISeq<double[]> points) {
    ...
    public static TravellingSalesman of(int stops, double radius) {
        ...
        return new TravellingSalesman(points.toISeq());
    }
    ...
    public static void main(String[] args) {
        ...
        TravellingSalesman tsm = TravellingSalesman.of(stops, R);
        ...
        Phenotype<EnumGene<double[]>, Double> best = engine.stream()
                //Truncate the evolution stream after 25 "steady" generations
                .limit(bySteadyFitness(5000))
                //The evolution will stop after maximal 250 generations
                .limit(5000)
